...
export default async function DropsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fdf8f3', maxWidth: '480px', margin: '0 auto', padding: '0 0 40px' }}>
      {/* Header */}
      <div style={{ padding: '20px 20px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <Link href="/seller/login" style={{ color: '#9a8f87', fontSize: '13px', textDecoration: 'none' }}>
          Seller →
        </Link>
      </div>
      ...
      <div style={{ padding: '28px 20px 0' }}>
        {live.length > 0 && (
          <section style={{ marginBottom: '28px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
              ...
              <span style={{ color: '#b8a898', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.5px', fontWeight: 600 }}>Live Now</span>
        ...
        <section>
          <p style={{ color: '#9a8f87', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '12px', fontWeight: 600 }}>
            Upcoming Drops
          </p>
          {upcoming.length === 0 ? (
            <p style={{ color: '#9a8f87', fontSize: '14px' }}>No upcoming drops. Check back soon!</p>
          ) : (
    ...
    <Link href={`/${drop.slug}`} style={{ textDecoration: 'none' }}>
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ color: '#1a1a1a', fontWeight: 600, fontSize: '15px', margin: '0 0 3px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{drop.title}</p>
        ...
        <span style={{ color: '#9a8f87', fontSize: '18px' }}>›</span>
      </div>
    </Link>
  )
}
